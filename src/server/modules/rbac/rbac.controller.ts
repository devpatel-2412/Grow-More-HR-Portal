...
import { sendOk, sendCreated, sendNoContent } from '../../shared/utils/response.util.js';
import { ALL_PERMISSIONS, type Permission } from '../../shared/permissions/permissions.js';
import type { z } from 'zod';
import type { assignPermissionSchema, createDepartmentPermissionSchema, createBranchPermissionSchema, assignUserRoleSchema } from './rbac.validators.js';
...
/** Always the 6 fixed roles — see rbac.repository.ts's findRolesByTenant. */
