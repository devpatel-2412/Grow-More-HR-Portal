...
const read = requirePermission(PERMISSIONS.ANNOUNCEMENT_READ);
...
announcementRouter.get('/', read, validate({ query: listAnnouncementsQuerySchema }), asyncHandler(listAnnouncements));
