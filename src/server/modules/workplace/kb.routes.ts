...
const read = requirePermission(PERMISSIONS.KB_READ);
...
kbRouter.get('/', read, validate({ query: listArticlesQuerySchema }), asyncHandler(listArticles));
kbRouter.get('/:id', read, validate({ params: idParamSchema }), asyncHandler(getArticle));
