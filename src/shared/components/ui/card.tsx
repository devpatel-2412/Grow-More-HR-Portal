...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn('surface-card rounded-2xl p-6', className)} {...props} />;
}
...
/** Action-bar-style footer (e.g. a Save/Cancel row). Not for PaginationBar — that ships its own border-t. */
