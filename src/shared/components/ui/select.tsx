...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-md py-2 pl-8 pr-3 text-sm text-[var(--foreground)] outline-none data-[highlighted]:bg-[var(--muted)]',
      className,
    )}
    {...props}
  >
